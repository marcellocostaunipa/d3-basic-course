...
d3.json("data/data.json").then(function(data) {
  ...
  const btnSortByName = document.getElementById('btn-sort-by-name').addEventListener('click', function(){
    console.log('Sort by name clicked');
    fruits.sort((a, b) => a.name.localeCompare(b.name));
    createChart();
  });

  const btnSortByValue = document.getElementById('btn-sort-by-value').addEventListener('click', function(){
